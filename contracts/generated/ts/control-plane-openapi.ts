...
export const CONTROL_PLANE_OPENAPI_DOCUMENT = {
  ...
  "tags": [
    {
      "name": "docs",
      "description": "This surface's own description, served from contracts/ - the schema of record. Off unless CONTROL_PLANE_DOCS=1."
    },
    {
      "name": "operator-auth",
  ...
  "paths": {
    "/openapi.json": {
      "get": {
        "operationId": "getControlPlaneOpenApiDocument",
        "tags": [
          "docs"
        ],
        "security": [],
    ...
    "/docs": {
      "get": {
        "operationId": "getControlPlaneApiDocs",
        "tags": [
          "docs"
        ],
        "security": [],
        "summary": "Swagger UI for the internal surface",
